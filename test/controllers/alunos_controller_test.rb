...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference("Aluno.count") do
      post alunos_url, params: { aluno: { age: @aluno.age, email: @aluno.email, name: @aluno.name } }, as: :json
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { age: @aluno.age, email: @aluno.email, name: @aluno.name } }, as: :json
    assert_response :success
  end
